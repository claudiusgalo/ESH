...
export class ListingResolver {
  ...
  @Query(() => [Listing]) // Sets the GraphQL type for the query as an array of Listing
  async getListings(): Promise<Listing[] | null> {
    // Relations will allow us to access the creator of each listing
    return Listing.find({ relations: ['creator'] }); // Returns a promise
  }
